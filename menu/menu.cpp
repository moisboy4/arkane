...
static const char* EdgebugTypes[] = { "arkane (og)","lobotomy" };
...
void miscellaneous() {
    ...
    ImGui::Columns(2, nullptr, false); {
        ImGui::BeginChild(("misc.movement"), ImVec2(0, 190), true, ImGuiWindowFlags_MenuBar); {
            ...
            if (c::movement::auto_align) {
                ...
                ImGui::Combo("##align", &c::movement::align_selection, "arkane (og)\0lobotomy\0");
            ...
            if (c::movement::pixel_surf) {
                ...
                ImGui::Combo("##pstype", &c::movement::px_selection, "arkane (og)\0lobotomy\0");
            ...
            if (c::assist::assist)
            {
                if (c::assist::assist_render || c::assist::bounce_assist_render) {
                    ...
                    ImGui::Combo(("##asrendertype"), &c::assist::assist_render_style, "arkane\0lobotomy\0");
                }
    ...
    ImGui::NextColumn(); {
        ImGui::BeginChild(("misc.config"), ImVec2(0, 190), true, ImGuiWindowFlags_MenuBar); {
            ...
            ImGui::NextColumn(); {
                    ...
                    for (auto i = 0; i < IM_ARRAYSIZE(choices1); i++)
                        if (ImGui::Selectable(choices1[i]))
                            if (i == 0) {
                                if (config_index == -1) {
                                    if (interfaces::engine->is_in_game()) {
                                        interfaces::chat_element->chatprintf("#arkane#_print_failed");
                                    }
                                }
                                else {
                                    c::save(config_index);
                    ...
                    for (auto i = 0; i < IM_ARRAYSIZE(choices2); i++)
                        if (ImGui::Selectable(choices2[i]))
                            ...
                            if (config_index == -1) {
                                ...
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_aimbot");
                                }
                            }
                            else if (i == 1) {
                                ...
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_visuals");
                                }
                                menu::load_font_index();
                                surface::initialize();
                                menu::fonts_initialized = true;
                                ...
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_mvm");
                                }
                            }
                            else if (i == 3) {
                                ...
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_indicators");
                                }
                            }
                            else if (i == 4) {
                                ...
                                getskins();
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_skins");
                                    features::skins::forcing_update = true;
                                }
                            }
                            else if (i == 5) {
                                ...
                                if (interfaces::engine->is_in_game()) {
                                    interfaces::chat_element->chatprintf("#arkane#_print_loaded_misc");
                                }
                            }
                ...
                if (ImGui::Button("refresh", ImVec2(-1, 15))) {
                    ...
                    if (interfaces::engine->is_in_game()) {
                        interfaces::chat_element->chatprintf("#arkane#_print_refreshed");
                    }
                }
                ImGui::PopItemWidth();
                ImGui::PopStyleVar();
        ...
        ImGui::BeginChild(("misc.main"), ImVec2{ }, true, ImGuiWindowFlags_MenuBar); {
            ...
            ImGui::Checkbox(("arkane status"), &c::misc::discord_rpc);
    ...
    ImGui::Columns(2, nullptr, false); {
        ImGui::BeginChild(("fonts.main"), ImVec2{ }, true, ImGuiWindowFlags_MenuBar); {
            ...
            if (ImGui::Button("reload fonts")) {
                ...
                if (interfaces::engine->is_in_game()) {
                    interfaces::chat_element->chatprintf("#arkane#_print_reloaded");
                }
                menu::fonts_initialized = true;
                menu::load_font_index();
                surface::initialize();
